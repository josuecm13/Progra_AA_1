...
namespace Progra_AA_1
{
    public partial class MainMenu : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            form.SetComponents(Int32.Parse(txt_population.Text), Int32.Parse(txt_gens.Text), Int32.Parse(txt_prpMut.Text), Int32.Parse(txt_prbCross.Text), 0, int.Parse(txt_Genes_a_mutar.Text), int.Parse(txt_selection.Text), new Bitmap(path));// int.Parse(txt_selection.Text);
            form.Show();
